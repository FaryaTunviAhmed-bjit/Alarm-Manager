...
class AlarmAdapter(
    ...
    override fun onBindViewHolder(holder: AlarmViewHolder, position: Int) {
        ...
        holder.timeTextView.text = SimpleDateFormat("hh:mm a", Locale.getDefault()).format(Date(alarm.hour * 3600000L + alarm.minute * 60000L))
        holder.labelTextView.text = if (alarm.isEnabled) "Enabled" else "Disabled"
